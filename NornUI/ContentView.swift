    ...
    private var detail: some View {
        ...
        case .host:
            ...
            HostFeatureView(
				...
				metricHistory: appModel.usesRemoteMetricsHistory ? appModel.remoteHostMetricsHistory : appModel.hostMetricsHistory,
				serviceMetricHistory: appModel.usesRemoteMetricsHistory ? appModel.remoteServiceMetricsHistory : appModel.serviceMetricsHistory,
                historyRevision: appModel.hostHistoryPresentationRevision,
                historyStatus: appModel.historyStatus,
                includeLatestHistorySample: !appModel.usesRemoteMetricsHistory,
